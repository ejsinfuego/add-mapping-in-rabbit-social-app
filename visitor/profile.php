...
main tbody{
    ...
    <?php elseif (isset($_SESSION['edit-post'])) : // error message for not successful updating post ?>
        ...
        <?php elseif (isset($_SESSION['edit-user'])) : // error message for not successful updating user info ?>
        <div class="alert__message error container">
                <p>
                    <?= $_SESSION['edit-user'];
        ...
        <?php elseif (isset($_SESSION['edit-user-success'])) : // success message for updating user info ?>
        <div class="alert__message success container">
                <p>
        ...
        <aside>
            <ul>
            <?php if(isset($_SESSION['user_is_visitor'])): ?>
                <li>
...
<div class="col-sm-12">
    ...
    <a href="update-profile.php?id=<?= $avatar['id'] ?>" class="btn sm"><img src="<?= ROOT_URL ?>assets/edit.png"  class="edit"></a></td>
