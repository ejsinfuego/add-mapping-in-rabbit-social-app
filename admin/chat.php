...
<!-- //LOGIC FOR CHAT
//get the unique_id of the user as outcoming_msg_id while the incoming_msg_id is the unique_id of the user you are chatting with. JS scripts sets an interval when to refresh pages so message could be received asap.-->
<body class="h">
