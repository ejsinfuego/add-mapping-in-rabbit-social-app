            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="edit-post.php?id=<?= $post['id'] ?>" class="btn sm"><img src="<?= ROOT_URL ?>assets/edit.png" class="edit"></a></td>
                        <td><a href="delete-post.php?id=<?= $post['id'] ?>" class="btn sm danger"><img src="<?= ROOT_URL ?>assets/delete.png" class="delete"></a></td>
                    </tr>
                    <?php endwhile ?>
                </tbody>
            </table>
